...
void * popCurrent(List * list) {
    ...
    if(list->head == list->tail){
        ...
        lista->tail = nodoBorrar->prev;
        lista->tail->next = NULL;
    }
    else{
        nodoBorrar->prev->next = nodoBorrar->next;
        nodoBorrar->next->prev = nodoBorrar->prev;
    }
    list->current = nodoBorrar->next;
    free(nodoBorrar);
